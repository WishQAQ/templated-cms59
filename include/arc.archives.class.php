    ...
    function GetPreNext($gtype='')
    {
        ...
        if(count($this->PreNext)<2)
        {
            ...
            if(is_array($preRow))
            {
                ...
                $this->PreNext['pre'] = "上一篇：<a href='$mlink' id='kdyk31prev' class='prev'>{$preRow['title']}</a> ";
                $this->PreNext['preimg'] = "<a href='$mlink'><img src=\"/templets/foryou/images/upzu.jpg\" alt=\"{$preRow['title']}\" title=\"{$preRow['title']}\"/></a> "; 
            }
            else
            {
                $this->PreNext['pre'] = " ";
                $this->PreNext['preimg'] ="<a href='javascript:void(0)' alt=\"\"><img src=\"/templets/foryou/images/upzu.jpg\" alt=\"对不起，没有上一图集了！\" title=\"对不起，没有上一图集了！\"/></a>";
            }
            if(is_array($nextRow))
            {
                $mlink = GetFileUrl($nextRow['id'],$nextRow['typeid'],$nextRow['senddate'],$nextRow['title'],$nextRow['ismake'],$nextRow['arcrank'],
                $nextRow['namerule'],$nextRow['typedir'],$nextRow['money'],$nextRow['filename'],$nextRow['moresite'],$nextRow['siteurl'],$nextRow['sitepath']);
                $this->PreNext['next'] = "下一篇：<a href='$mlink' id='kdyk31prev' class='prev'>{$preRow['title']}</a> ";
                $this->PreNext['nextimg'] = "<a href='$mlink'><img src=\"/templets/foryou/images/nextzu.jpg\" alt=\"{$preRow['title']}\" title=\"{$preRow['title']}\"/></a>  ";
            }
            else
            {
                $this->PreNext['next'] = " ";
                $this->PreNext['nextimg'] ="<a href='javascript:void(0)' alt=\"\"><img src=\"/templets/foryou/images/nextzu.jpg\" alt=\"对不起，没有下一图集了！\" title=\"对不起，没有下一图集了！\"/></a>";
            }
        }
        if($gtype=='pre')
        {
